...
class LoginPage extends React.Component<{ loggedIn, login, history, reduxStorageLoaded }, { username, password }> {
    constructor( props ) {
        super(props);
        this.state = {
            username: '',
    ...
    componentDidUpdate(prevProps: Readonly<{ login; history }>, prevState: Readonly<{ username; password }>, snapshot?: any) {
        if (this.props.reduxStorageLoaded && this.props.loggedIn) {
            this.props.history.push('/user');
        }
    }
